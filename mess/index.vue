                        ...
                        <div class="flex flex-col gap-4">
                            <div class="flex flex-col" v-for="message in conversation">
                                <div v-if="message.role == 'system'"
                                    ...
                                    class="p-2 w-fit rounded-md self-start">{{ message.text }}</div>
                                <div v-else class="bg-blue-100 p-2 w-auto rounded-md self-end">{{ message.text }}</div>
                            </div>
                        </div>
                        <div v-if="system_question" class="flex mr-20 bg-gray-100 rounded-md p-4 flex-col h-auto gap-2">
